...
class DetectMachineLan():
	...
	#Función para el escaneo con scapy
	...
	def __handleArguments(self,argv=None):
		...
		#Añadimos el parsio de dos parametros nuevos.
		...
		#Tenemos que obligar a indicar el interface cuando se hace el escano de esta manera.
